...
model = YOLO("/home/salvarado/TFM/resultados/result_mambayolo/parches_original_1024_50ep_M3/weights/best.pt")
...
print("Resultados MambaYOLO-B Parches Original - Test")
print("-" * 45)
